    ...
    <>
      <div className="layer-header">
        <div className="home-header">
          <p>
            De los poetas aprendí que las palabras son poderosas, entonces
            decidí hacer de las letras mis mejores armas.
          </p>
        </div>
      </div>
      <div className="row sobre-mi">
        ...
        <div className="col col-md-5 sobre-mi__vector">
          ...
          <img
            className="notebookVector notebookVectorMax"
            src={notebookVectorMax}
            alt="vector"
          />
      ...
      <div className="row i-copywriting">
        <div className="col-12 col-md-6 col-lg-5 i-copywriting__title">
          ...
          <h3 className="i-copywriting-responsiveT">
            La importancia <br />
            del <span>copywriting</span>
          </h3>
        </div>
