import accuChek from "../assets/img/proyectos/redes-sociales/accu-chek.png";
import accuChekImg from "../assets/img/proyectos/personajes/accu-chek.png";
import aututor from "../assets/img/proyectos/naming/aututor.png";
import bajoControl from "../assets/img/proyectos/naming/bajo-control.png";
import blogging from "../assets/img/blogging.png";
import claro from "../assets/img/proyectos/redes-sociales/claro.png";
import figurella from "../assets/img/proyectos/redaccion-web/figurella.png";
import globalCatalog from "../assets/img/proyectos/redaccion-web/global-catalog.png";
import guion from "../assets/img/guion.png";
import insane from "../assets/img/proyectos/redaccion-web/insane.png";
import lifeStyles from "../assets/img/proyectos/redes-sociales/life-styles.png";
import mediaDream from "../assets/img/proyectos/blogging/media-dream.png";
import naming from "../assets/img/naming.png";
import personajes from "../assets/img/personajes.png";
import petBlanco from "../assets/img/proyectos/blogging/pet-blanco.png";
import recetas from "../assets/img/proyectos/guion/recetas.png";
import redaccionWeb from "../assets/img/redaccion-web.jpg";
import redesSociales from "../assets/img/redes-sociales.png";
import roche from "../assets/img/proyectos/guion/roche.png";
import totalSonrisa from "../assets/img/proyectos/redaccion-web/total-sonrisa.png";
...
export const servicios = [
  {
    id: 1,
    nombre: "Redacción web",
    descripcion:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi doloremquidem ad molestiae ipsam? Consequatur dolorem laboriosam unde teneturvoluptas, voluptates reprehenderit cumque quidem totam placeat liberodolorum natus praesentium.",
    img: redaccionWeb,
  },
  {
    id: 2,
...
export const proyectos = [
  ...
  },
  {
    servicio: "Blogging",
    descripcion:
      "Proyectos de blogging realizados para diferentes marcas y tonos comunicacionales. He trabajado para diferentes rubros como; fitness, TI, medicina veterinaria, salud dental y marketing.",
    proyectos: [
      {
        id: 1,
        img: figurella,
  ...
  },
  {
    servicio: "Truchos",
    descripcion:
      "Estos trabajos fueron realizados a modo de práctica en clases de copywriting.",
    proyectos: [
      {
        id: 1,
        img: trucho1,
